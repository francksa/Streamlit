...
HH_UNIVERSE_DEFAULT = 70_132_819  # households in Grocery Chain footprint (22 states) or your chosen HH base
...
"""
    ...
    st.caption("X = Category prevalence (%). Y = Grocery Chain salience scenario (%). Bubble size = Accessible TAM (HHs).")
    ...
    bubble = (
        ...
        .encode(
            ...
            y=alt.Y("Grocery Chain salience – scenario (%)", title="Grocery Chain salience – scenario (%)"),
            ...
            tooltip=[
                ...
                alt.Tooltip("Grocery Chain salience – current (%)", format=".1f"),
                alt.Tooltip("Grocery Chain salience – scenario (%)", format=".1f"),
